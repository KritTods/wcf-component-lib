...
const BaseGrid = (props: GridProps) => {
	...
	return (
			...
			theme={{
				components: {
					Table: {
						...
						footerBg: footerBg ? footerBg : "#fafafa",
					},
					Pagination: {
		...
		>
			<div
				className={`base-grid w-full flex flex-col items-center ${hideHeader && "hide-header-base-grid"} ${bordered && "bordered"} ${isHaveBorderBottomLeftRight && "is-have-border-bottom-left-right"} ${isContentSmallFont && "is-content-small-font"} ${type === "light" && "remove-border-header"}`}
			>
				<Table
